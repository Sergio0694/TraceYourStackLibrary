...
{
    /// <summary>
    /// A setting imlementation for WinRT
    /// </summary>
    public class WinRTSettings : ISettingsManager
    {
        /// <summary>
        /// Gets the settings container to use
        /// </summary>
        private readonly IPropertySet Container = ApplicationData.Current.LocalSettings.CreateContainer("TraceYourStack", ApplicationDataCreateDisposition.Always).Values;
